...
int main(){
    ...
    glm::mat4 projection_matrix = glm::ortho(-1.0f, 1.0f, -1.0f, 1.0f, -1.0f, 1.0f); // projection matrix here
    glm::mat4 view_matrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.25, 0.25, 0));
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        // imgui
        ImGui::Text("An amazing opengl application");                           // Display some text (you can use a format string too)
        ImGui::SliderFloat3("float", &translation.x, -1.0f, 1.0f);            // Edit 3 float using a slider from 0.0f to 1.0f    
